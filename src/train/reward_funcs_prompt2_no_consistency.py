...
def prompt2_no_consistency_reward(completions: Sequence[str], assistant: Sequence[str], **kwargs) -> List[float]:
    """
    Prompt-2 reward with consistency disabled (W_CONS=0.0).
    Combined reward:
      Average over 3 regions of:
        0.75 * region_field_accuracy + 0.0 * region_consistency + 0.1 * region_format
    """
    rewards = []
